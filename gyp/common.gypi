...

{
  ...
  # instruction_set - current instruction set
  # <Values generated by build_environ.generate()>


  'variables': {
    # TODO: move most of the following paths/constants to the gyp_generate,
    #       pass them here via -D, but at the same time write them to .json
    #       file for Gradle.
    ...
    'boot_art_path': '<(android_data_path)/dalvik-cache/<(instruction_set)/boot.art',
    'boot_oat_path': '<(android_data_path)/dalvik-cache/<(instruction_set)/boot.oat',
