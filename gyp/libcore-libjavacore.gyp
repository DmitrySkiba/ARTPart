  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '<(local_root)/luni/src/main/native/AsynchronousSocketCloseMonitor.cpp',
        ...
        '<(local_root)/luni/src/main/native/java_io_Console.cpp',
        ...
        '<(local_root)/luni/src/main/native/libcore_io_OsConstants.cpp',
        ...
        '<(local_root)/luni/src/main/native/realpath.cpp',
